        ...
        <!-- <div class="col-md-8 col-md-offset-2"> -->
            <div class="panel panel-default">
                <div class="panel-heading"><b>Buyer's Details</b>
                  <a href="{{ URL::to('/') }}/forwarder/create" class="btn btn-primary btn-xs pull-right"><i class=""></i> Add</a>
                </div>
                ...
                @endif
                <table id="forwarders" class="table table-bordered">
                    <thead>
                        <th>Sr No.</th>
                        <th>Name</th>
                        <th>country</th>
